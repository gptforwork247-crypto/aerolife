...
const copy = {
 en: {nav:['Home','Service','Experience','Team','Contact us'],hero:'Providing the highest standard of patient care & transportation is our top priority.',years:'Years of Experience',countries:'Countries',cases:'Patient Cases',services:['One Stop Service','Medical Equipment','Transportation Choice'],desc:['With more than 10 trusted partners, we provide seamless support throughout every patient journey.','High-quality medical equipment to support safe and effective patient care throughout the journey','Air ambulance, ground transportation, and ferry services are available to meet your medical transportation needs.'],partners:'Our Partnership',story:'AeroLife Story',storyText:'At AeroLife Thailand, we believe medical transportation is more than simply moving a patient from one destination to another. It is about providing trusted, compassionate care at every step. With a highly experienced medical team, fully equipped medical resources, and exceptional service — treating every patient like a member of our own family.',watch:'Watch our story',voices:'Patient Voices',voiceSub:'Real journeys. Heartfelt words.',care:'When Care Matters Most, We Go Further.',careText:'Combining medical expertise, aviation precision, and genuine compassion, we deliver exceptional care throughout your journey.',team:'Medical Team',teamSub:'Dedicated people. Exceptional care. Meet the specialists who make every journey possible.',director:'Flight Medical Director',directorText:'Leading our medical team with experience, compassion, and a commitment to patient care — from the first conversation to a safe arrival.',roles:['Flight Doctor','Flight Nurse','Paramedic','EMT'],roleText:['Expert medical oversight and patient care in the air.','Attentive monitoring and compassionate care at every step.','Skilled support throughout medical transportation.','Coordinated support from departure to destination.'],contact:'Every journey starts with a conversation.',contactSub:'Speak with our team about your medical transportation needs.',talk:'Contact our team',view:'View letter',pause:'Pause slideshow',resume:'Resume slideshow'},
